...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.allTransactions = QtGui.QTextEdit()
...
""))
        ...
        self.scrollArea.setWidget(self.allTransactions)
...
""))
    ...
    def getTransactions(self):
        with open("Transactions.txt",'r') as f:
            listOfTransactions = f.readlines()
            f.close()

        for each in listOfTransactions:
            self.allTransactions.setPlainText(self.allTransactions.toPlainText() + each)
